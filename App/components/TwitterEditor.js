...
import { Image,StyleSheet,StatusBar,CameraRoll,Text,TextInput,TouchableHighlight,View, Platform } from 'react-native';
...
class FunctionView extends Component{
    ...
    constructor() {
        ...
        console.log("FunctionView:",this.state);
    }
                ...
                <View style={styles.functionIconContainer}>
                    ...
                    <View style={styles.functionBtn}>
                        ...
                        <TouchableHighlight style={this.props.numOfText==140?styles.btn:styles.activeBtn}>
                            <Text style={this.props.numOfText==140?styles.btnText:styles.activeBtnText}>전송</Text>
                        </TouchableHighlight>
                    </View>
                </View>
...
export default class TwitterEditor extends Component{
    constructor() {
        super();
        this.state = {
            numOfText:140,
        };
        console.log("TwitterEditor:",this.state);
    }

    componentDidMount() {
        if(Platform.OS === 'ios') {
            StatusBar.setBarStyle(0); // only ios
        } else {
        ...
        return(
            <View style={styles.container}>
                <View style={styles.iconContainer}>
                    <Image style={styles.icon} source={require('../images/app/icon.png')}></Image>
